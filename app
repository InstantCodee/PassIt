...
function test {
    ...
    export DISPLAY=:0
    ./com.github.instantcodee.passit --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.instantcodee.passit-pot
    ninja com.github.instantcodee.passit-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.instantcodee.passit "${@:2}"
    ;;
"test")
    test
    ;;
